...
export default function Answer(props) {
    ...
    const stylesAfterCheck = {
        background: props.isCorrect && props.isSelected ? "lightgreen" : !props.isCorrect && props.isSelected ? "red" : props.isCorrect && !props.isSelected ? "lightgreen" : "" ,
        border: props.isCorrect && props.isSelected ? "none" : !props.isCorrect && props.isSelected ? "1px solid black" : props.isCorrect && !props.isSelected ? "none" : ""
    }
    return (
